...
import { advisors } from "../../../lib/data/team";
...
{/* <div className="w-full text-center font-Maven text-2xl">alumni MEMBERS | AUTOZ</div> */}
      ...
      <div className="w-[700px] hidden md:block fixed top-0 left-0  h-full">
        ...
        <div className="text-xs">
          ...
          {advisors.length} Active Members
          </Opacity>
        </div>
      </div>
      </div>
      ...
      {advisors &&
        <div  className="pt-[200px] md:pt-0 w-full grid md:h-screen grid-col-1 md:grid-cols-3  overflow-x-auto md: ">
          {advisors.map((i,index)=>(
            
            <div key={index} className="hover:w-64 md:my-auto mx-auto transition-all duration-500 ease-in-out group   px-4 md:pb-5  w-[300px] md:w-60 bgred-400"> 
